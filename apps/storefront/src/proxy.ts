...
import { getMedusaBackendUrl } from "@lib/backend-url"
...
async function getRegionMap(cacheId: string) {
  ...
  if (
    ...
    // Fetch regions before selecting the storefront country.
...
/**
 * Selects the country prefix for storefront requests.
 */
